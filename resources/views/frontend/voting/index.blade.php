...
<body>
    ...
    <img class="img-fluid" style="width: 23%; height: 20%; margin-right: 40px;" src="https://static.promediateknologi.id/crop/0x0:0x0/0x0/webp/photo/jawapos/2019/05/Jokowi-Dok.jpeg" alt="Card image cap">
    <img class="img-fluid" style="width: 23%; height: 20%; margin-right: 25px;" src="https://static.promediateknologi.id/crop/0x0:0x0/0x0/webp/photo/jawapos/2019/05/Jokowi-Dok.jpeg" alt="Card image cap">
    <img class="img-fluid" style="width: 23%; height: 20%; margin-right: 40px;" src="https://static.promediateknologi.id/crop/0x0:0x0/0x0/webp/photo/jawapos/2019/05/Jokowi-Dok.jpeg" alt="Card image cap">
</div>
            <div class="col-md-12">
                <div class="row">
